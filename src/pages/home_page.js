...
import {
	...
	IconTextButton,
	TextIconButtonBg,
} from "../components/icon_text_button.js";
...
function HomePage() {
	document.title = isPortuguese()
		...
		: "Raphael Silva | Full Stack Developer";
	...
	const WORKS_LIST = [
			...
			images: [
				{
					...
					source: "/src/images/shoe-store-1.png",
				},
				{
					title: isPortuguese() ? "Tela inicial" : "Home screen",
					source: "/src/images/shoe-store-2.png",
				},
			],
		},
		{
			...
			images: [
				{
					title: isPortuguese() ? "Tela inicial" : "Home screen",
					source: "/src/images/sports-store-1.png",
				},
				{
					title: isPortuguese() ? "Detalhes do produto" : "Product details",
					source: "/src/images/sports-store-2.png",
				},
			],
		},
		{
			...
			images: [
				{
					title: isPortuguese() ? "Tela de login" : "Login screen",
					source: "/src/images/nba-1.png",
				},
				{
					title: isPortuguese() ? "Tela inicial" : "Home screen",
					source: "/src/images/nba-2.png",
				},
				{
					title: isPortuguese() ? "Detalhes do produto" : "Product details",
					source: "/src/images/nba-3.png",
				},
				{
					title: isPortuguese() ? "Carrinho" : "Cart screen",
					source: "/src/images/nba-4.png",
				},
				{
					title: isPortuguese() ? "Tela de pagamento" : "Payment screen",
					source: "/src/images/nba-5.png",
				},
				{
					title: isPortuguese() ? "Tela de perfil" : "Profile screen",
					source: "/src/images/nba-6.png",
				},
			],
		},
		{
      ...
      e em breve terá mais funcionalidades.`
        ...
        and will soon have more functionabilities.`,
			year: "2022",
			technologies: ["figma", "firebase", "javascript", "SPA_Framework"],
			deploy_link: "https://gerenciador-001.web.app",
			rows: 2,
			images: [
				{
					title: isPortuguese() ? "Tela inicial" : "Home screen",
					source: "/src/images/gerenciador-1.png",
				},
				{
					title: isPortuguese()
						? "Caixa de pesquisa dinâmica"
						: "Dinamic search",
					source: "/src/images/gerenciador-2.png",
				},
				{
					title: isPortuguese() ? "Planejamento semanal" : "Weekly planning",
					source: "/src/images/gerenciador-4.png",
				},
				{
					title: isPortuguese() ? "Tela de listas" : "Lists screen",
					source: "/src/images/gerenciador-6.png",
				},
				{
					title: isPortuguese() ? "Tela de lista" : "List screen",
					source: "/src/images/gerenciador-7.png",
				},
				{
					title: isPortuguese() ? "Tela de configurações" : "Settings screen",
					source: "/src/images/gerenciador-8.png",
				},
				{
					title: isPortuguese() ? "Tela de registro" : "Register screen",
					source: "/src/images/gerenciador-5.png",
				},
				{
					title: isPortuguese() ? "Tela de login" : "Login screen",
					source: "/src/images/gerenciador-3.png",
				},
			],
		},
		{
      ...
      stream, for rent or buy.`,
			year: "2022",
			technologies: ["figma", "themoviedb API", "flutter"],
			github_link: "https://github.com/silvaRaphael/movie-app",
			images: [
				{
					title: isPortuguese() ? "Tela inicial" : "Home screen",
					source: "/src/images/movies-home.png",
				},
				{
					title: isPortuguese()
						? "Detalhes do filme/série"
						: "Movie/Serie details",
					source: "/src/images/movies-details-1.png",
				},
				{
					title: isPortuguese()
						? "Detalhes do filme/série"
						: "Movie/Serie details",
					source: "/src/images/movies-details-2.png",
				},
				{
					title: isPortuguese() ? "Tela de favoritos" : "Favorites screen",
					source: "/src/images/movies-favorites.png",
				},
				{
					title: isPortuguese() ? "Tela de categorias" : "Categories screen",
					source: "/src/images/movies-categories.png",
				},
				{
					title: isPortuguese() ? "Tela de pesquisa" : "Search screen",
					source: "/src/images/movies-search.png",
				},
			],
		},
		{
			...
			year: "2023",
			technologies: ["node.js", "typescript", "mongoDB", "socket.io"],
			github_link: "https://github.com/silvaRaphael/node-chatapp",
		},
		{
			title: isPortuguese()
				? "App de Agenda e Contas"
				: "Schedule and Bills App",
			category: isPortuguese() ? "Aplicativo" : "Mobile app",
			description: isPortuguese()
			...
			images: [
				{
					title: isPortuguese() ? "Tela inicial" : "Home screen",
					source: "/src/images/home-agenda-transparent.png",
				},
				{
					title: isPortuguese() ? "Editar agenda" : "Edit schedule",
					source: "/src/images/edit-agenda-transparent.png",
				},
				{
					title: isPortuguese() ? "Agenda" : "Schedule",
					source: "/src/images/calendar-agenda-transparent.png",
				},
				{
					title: isPortuguese() ? "Telas de Contas" : "Bills screen",
					source: "/src/images/bills-agenda-transparent.png",
				},
			],
		},
		{
			title: isPortuguese() ? "Sistema para pizzaria" : "Pizzeria web app",
			category: "Web App",
			description: isPortuguese()
				? `Um sistema simples para gerencia de pedidos e clientes de pizzaria, utilizando conceitos de arquitetura limpa.`
				: `A simple web app to manage clients and orders of a pizzeria, using clean architecture concepts.`,
			year: "2023",
			technologies: ["node.js", "typescript", "prisma", "mysql", "jest"],
			github_link: "https://github.com/silvaRaphael/pizzaria",
			images: [
				{
					title: isPortuguese() ? "Tela de login" : "Login page",
					source: "/src/images/pizzaria-login-page.png",
				},
				{
					title: isPortuguese() ? "Tela inicial" : "Home page",
					source: "/src/images/pizzaria-home-page.png",
				},
				{
					title: isPortuguese() ? "Novo pedido" : "New order",
					source: "/src/images/pizzaria-pedido-novo.png",
				},
				{
					title: isPortuguese() ? "Status do pedido" : "Order status",
					source: "/src/images/pizzaria-pedido-status.png",
				},
				{
					title: isPortuguese() ? "Pedido" : "Order",
					source: "/src/images/pizzaria-pedido.png",
				},
			],
		},
	];
		...
		children: [
			...
			Row({
                ...
                Full-Stack`,
										{
											style: {
												fontSize: BreakPoints.mobile.matches
													? Rem(3.5)
												...
												paddingRight: BreakPoints.mobile.matches
													? Rem(0)
													: BreakPoints.tablet.matches
													? Rem(3.5)
													: Rem(3),
                ...
                Developer`,
							...
							Row({
								style: {
									...
									paddingRight: isPortuguese() ? Rem(1.75) : Rem(0.5),
								...
								children: [
									Container({
										style: {
											...
											height: BreakPoints.mobile.matches
												? Rem(0.5)
												: BreakPoints.tablet.matches
												? Rem(0.75)
												: Rem(1),
											width: BreakPoints.mobile.matches
												? Rem(2)
												: BreakPoints.tablet.matches
												? Rem(3)
												: Rem(4.5),
											marginRight: BreakPoints.mobile.matches
												? Rem(1)
												: BreakPoints.tablet.matches
												? Rem(1.5)
												: Rem(1.7),
											marginBottom: BreakPoints.mobile.matches
												? Rem(0)
												: BreakPoints.tablet.matches
												? Rem(0)
												: Rem(0.1),
			...
			Row({
				...
				children: [
					Column({
						...
						children: [
							isPortuguese()
								? Text(
										`Sou um programador full-stack, sempre focado na busca pela melhoria e pelo aprendizado.
              <br>
              ...
              ◽ No desenvolvimento mobile tenho utilizado Flutter, e desenvolvido algumas aplicações muito interessantes.`,
								...
								: Text(
										`I'm a full stack programmer, always focused on improving and learning.
                <br>
                ...
                ◽ In mobile development I've been using Flutter, and developed some very interesting applications.`,
							...
							TextIconButtonBg({
								link:
									"mailto:raphaeltiago02@gmail.com?subject=" +
									encodeURI("Olá Raphael! Vim por seu portfólio."),
				...
				children: [
					Column({
						...
						children: [
							...
							Grid({
								columns: BreakPoints.mobile.matches
									? 1
									: BreakPoints.tablet.matches
									? Math.floor(SKILLS_LIST.length / 2)
									: SKILLS_LIST.length,
								style: {
									width: Size.fullContent,
									justifyContent: Align.start,
												...
												Column({
													...
													children: [
														...
														Grid({
															columns:
																item.list.length >=
																	Math.ceil(item.list.length / 2) &&
																Math.ceil(item.list.length / 2) >= 5
																	? 2
																	: 1,
															style: {
								...
								children: [
									Center({
										child: Row({
											crossAxis: BreakPoints.mobile.matches,
											style: {
												alignItems: BreakPoints.mobile.matches
													? Align.center
													: Align.start,
											},
											children: [
												...
												{
													title: isPortuguese() ? "📨 E-mail" : "📨 Email",
													link:
														"mailto:raphaeltiago02@gmail.com?subject=" +
														encodeURI("Olá Raphael! Vim por seu portfólio."),
												},
												{
													title: "📲 WhatsApp",
													link: "https://wa.me/5511914876996",
												},
											].map((item) => {
												return Link({
													target: "_blank",
